...
//        tester_match.addMatch();
        ...
        Match tester_match = new Match (team1, team2, Match.Categories.Confederations_Cup, Match.Rounds.Quarter_Final, 2,3,false, true,null,1, 2003);
        tester_match.addMatch();

        team1 = new Team("England", 9.43,0);
        team2 = new Team("United States", 2.4, 0);
        tester_match = new Match (team1, team2, Match.Categories.Confederation_Final, Match.Rounds.Semi_Final, 2,0,true, true,team1,2,2005);
        tester_match.addMatch();

        team1 = new Team("Morocco", 0,2);
        team2 = new Team("Algeria", 0, 8);
        tester_match = new Match (team1, team2, Match.Categories.Q_for_World_Cup, Match.Rounds.Final, 0,4,true, true,team2,4,2011);
        tester_match.addMatch();

        team1 = new Team("France", 0,0);
        team2 = new Team("Austria", 0, 0);
        tester_match = new Match (team1, team2, Match.Categories.Nations_League, Match.Rounds.Round_of_16, 0,1,false, true,null,6,2012);
        tester_match.addMatch();

        team1 = new Team("Sudan", 12.4,0);
        team2 = new Team("Libya", 4.6, 0);
        tester_match = new Match (team1, team2, Match.Categories.Friendly_Match, Match.Rounds.Group_Stage, 2,4,false, true,null,7,2013);
        tester_match.addMatch();

        team1 = new Team("Egypt", 0,0);
        team2 = new Team("France", 0, 0);
        tester_match = new Match (team1, team2, Match.Categories.Friendly_Match, Match.Rounds.Quarter_Final, 2,4,true, true,team1,7,2011);
        tester_match.addMatch();

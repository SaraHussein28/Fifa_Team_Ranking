...
//
//
//      //  clickOn("#team2_choice_box").clickOn("England");
//      //  clickOn("#score_team_two").write("3");
//
//        clickOn("#addMatchBtn");
//       // Label message = robot.lookup("#successMessage").queryAs(Label.class);
//        //assertNotNull(message);
//        //Assertions.assertThat
//        //Assertions.assertEquals("Match Is Added Successfully!", message.getText());
...
//      //  Assertions.asse("Match Is Added Successfully!", pane.getContentText());
//    }
//
//    @Test
